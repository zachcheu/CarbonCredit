...
public class Var extends Activity {
    ...
    public static Integer[] picId = {R.drawable.cloud, R.drawable.batman, R.drawable.rocketicon, R.drawable.tree, R.drawable.car,R.drawable.paperplane, R.drawable.bear};
}
